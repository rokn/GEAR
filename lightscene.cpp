...
namespace OGI
{
	...
	void LightScene::Initialize()
	{
		...
		_objectShader = new OGI::Shader("Shaders\\LightVertexShader.vs","Shaders\\LightFragmentShader.fs");
		_lampShader = new OGI::Shader("Shaders\\LightVertexShader.vs","Shaders\\LampFragmentShader.fs");
		_mesh = new OGI::Cube();
		...
		GLuint diffuseTexture = ResourceManager::LoadTexture("Images\\containerDiffuse.png");
		GLuint specularTexture = ResourceManager::LoadTexture("Images\\containerSpecular.png");
		GLuint emmisionTexture = ResourceManager::LoadTexture("Images\\matrix.jpg");
